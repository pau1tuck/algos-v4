...
import { usePageContext } from "@site/src/context/PageContext"; // Import PageContext
...
const TrueFalseQuestion: React.FC<TrueFalseQuestionProps> = ({
    ...
    const { registerQuestion, updateQuestionStatus } = usePageContext(); // Use PageContext

    // Register the question with the page context when the component mounts
    useEffect(() => {
        registerQuestion({
            id: questionId, // Unique ID for the question
            value: pointValue, // Points for the question
            status: "notStarted", // Initially not started
    ...
    const handleAnswer = (answer: boolean) => {
        ...
        updateQuestionStatus(questionId, {
            status: "completed", // Mark the question as completed
