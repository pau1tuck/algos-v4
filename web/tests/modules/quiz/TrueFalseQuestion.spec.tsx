...
import { QuizProvider } from '@site/src/modules/quiz/utils/QuizContext';
import { QuestionStatus } from '@site/src/modules/quiz/types';

// Mock the useQuizContext hook
jest.mock('../../../src/modules/quiz/utils/useQuizContext', () => ({
...
describe('TrueFalseQuestion', () => {
    ...
    it('renders the question and answer buttons', () => {
        render(
            <QuizProvider>
                <TrueFalseQuestion question={mockQuestion} correctAnswer={mockCorrectAnswer} />
            </QuizProvider>
        );
    ...
    it('handles correct answer', () => {
        ...
        expect(mockUpdateQuestionStatus).toHaveBeenCalledWith(expect.any(Number), QuestionStatus.Correct);
    });
    ...
    it('handles incorrect answer', () => {
        ...
        expect(mockUpdateQuestionStatus).toHaveBeenCalledWith(expect.any(Number), QuestionStatus.Incorrect);
    });
});