...
// ADD:
/* Profession: Track the user’s selected profession or specialization.
Skill: Reflect the user's current skill level.
Health: Include if you’re implementing health mechanics.
Rank: Track rank/level dynamically as it changes with user progress. */
